...
<div class="card">
  ...
  <form method="post" action="<?= BASE_URL ?>/admin/especialidades/nueva" style="display:flex;gap:10px;align-items:flex-end;max-width:520px;margin-bottom:18px">
  ...
  <table>
    ...
    <tr>
      <td>#<?= $e['id'] ?></td>
      <td>
        <form method="post" action="<?= BASE_URL ?>/admin/especialidades/editar" style="display:flex;gap:6px">
          <input type="hidden" name="_csrf" value="<?= Auth::csrf() ?>">
      ...
      <td>
        <form method="post" action="<?= BASE_URL ?>/admin/especialidades/borrar" style="display:inline">
          <input type="hidden" name="_csrf" value="<?= Auth::csrf() ?>">
          <input type="hidden" name="id" value="<?= $e['id'] ?>">
