...
<header class="navbar">
  <div class="container navbar-inner">
    <a href="/" class="brand"><span class="brand-dot"></span> ReparaYa</a>
    <nav class="nav-links">
      <a href="/">Inicio</a>
      ...
      <?php if ($u && $u['rol']==='admin'): ?>
        ...
        <a href="/admin/tecnicos">Tecnicos</a>
    ...
    <div class="nav-user">
      <?php if ($u): ?>
        <a href="/perfil" class="btn btn-sm">Hola, <?= htmlspecialchars($u['nombre']) ?></a>
