...
class ClienteController extends Controller
{
    ...
    public function nuevoStore(): void
    {
        ...
        if (!$fechaServicio) {
            $this->redirect('/cliente/avisos/nuevo?error=' . urlencode('Falta la fecha'));
        }
        ...
        if ($urgencia === 'Estandar') {
            ...
            if ($fechaTs < $minTs) {
                $this->redirect('/cliente/avisos/nuevo?error=' . urlencode(
    ...
    public function cancelar(): void
    {
        ...
        if ($inc['tipo_urgencia'] === 'Estandar') {
            ...
            if ($diff < HORAS_ANTELACION_ESTANDAR * 3600) {
                $this->redirect('/cliente/avisos?error=' . urlencode(
